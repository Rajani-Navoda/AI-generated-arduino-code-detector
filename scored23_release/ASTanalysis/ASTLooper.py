# ------------------------------------------------------------------------
# This file is to loop the ASTParse.py file for all the files in the datasets
# ------------------------------------------------------------------------
...
def parseControlFolder(controlfolder, destinationfolder):
    ...
    for x in controlfilelist:
        subprocess.run(["python3", "ASTParser.py", x, destinationfolder])
...
def parseAutopilotFolder(autopilotfolder, destinationfolder):
...
def main():
    ...
    inputArgument.add_argument(
        "destfolder", help="Add absolute path to destination folder"
    )
    ...
    parseControlFolder(SourceControlDataFolder, destFolderPath)

    # ---------------------------------------------------
    # To Parse All Data Files in Autopilot Folder
    # ---------------------------------------------------

    parseAutopilotFolder(SourceAutopilotDataFolder, destFolderPath)
