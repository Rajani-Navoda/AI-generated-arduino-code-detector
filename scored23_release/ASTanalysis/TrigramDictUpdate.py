...
def funcOfControl(controlfilelist, destPath, pathToEmptyDict, dictFile):
    for eachPath in controlfilelist:
        ...
        for i in range(len(treeNodes) - 2):
            index = (
        ...
        dictionarypath = os.path.join(destPath, "Trigram", rootFolder, parentFolder)
...
def main():
    ...
    relative_pathToEmptyDict = "../Processed/EmptyDictionaries/dictofTrigram.pickle"
