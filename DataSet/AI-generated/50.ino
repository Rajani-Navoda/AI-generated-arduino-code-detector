/*
  ...
  Configures the CAN1 module in loopback mode with a 100 kbps bitrate.
...
const uint32_t CAN_BITRATE = 100000; // 100 kbps
...
void setup() {
  ...
  Serial.println("CAN1 Initialized and Loopback Mode Enabled at 100 kbps.");
}
