...
#include <Adafruit_ILI9341.h> // Replace with your specific display library
...
void setup() {
  ...
  // Load your GIF stored in FLASH
  // gif.open("example.gif"); // Uncomment to load a GIF from SPIFFS or SD
}
