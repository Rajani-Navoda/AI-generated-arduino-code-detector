...
// Create settings object for MCP2517FD
ACAN2517FDSettings settings(MCP2517FD_CS_PIN, MCP2517FD_INT_PIN);

// Create driver object for MCP2517FD
ACAN2517FD can1;
...
void setup() {
  ...
  settings.mControllerTransmitFIFORetransmissionAttempts = ACAN2517FDSettings::ThreeAttempts;
