...
//  Example with ACAN2515Settings constructor with explicit bit rate settings
//——————————————————————————————————————————————————————————————————————————————
...
//--- Configure ACAN2515
  ...
  ACAN2515Settings settings (QUARTZ_FREQUENCY, // Only used for computing actual bit rate
