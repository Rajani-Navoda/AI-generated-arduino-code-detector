...
//	while (!Serial);		// For Leonardo only. No effect on other Arduino.
	...
	PortLight0.begin(EXPANDER_PIN(EXPANDER_ID, 0), ANALOG);
	PortLight1.begin(EXPANDER_PIN(EXPANDER_ID, 4), ANALOG);
	PortLight2.begin(EXPANDER_PIN(EXPANDER_ID, 7), ANALOG);
